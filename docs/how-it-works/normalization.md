...
## [`log2_transform()`](../reference/pp/log2_transform.md)
...
### What [`normalize()`](../reference/pp/normalize.md) records
...
## [`adjust_ptm_by_protein()`](../reference/pp/adjust_ptm_by_protein.md)
