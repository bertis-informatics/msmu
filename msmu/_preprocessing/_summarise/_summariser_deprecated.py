...
#         self._decoy_agg_dict: dict = dict()
...
#     def summarise_decoy(self) -> pd.DataFrame:
#         if "decoy" not in self._adata.uns.keys():
#             raise ValueError("No decoy data found in adata.uns['decoy']")
        
#         decoy_df:pd.DataFrame = self._adata.uns["decoy"].copy()
#         summ_decoy_df: pd.DataFrame = decoy_df.groupby(
#             self._col_to_groupby, observed=False
#         ).agg(self._decoy_agg_dict)
#         summ_decoy_df: pd.DataFrame = summ_decoy_df.rename_axis(index=None)

#         return summ_decoy_df
...
#         self._decoy_agg_dict: dict[str, str] = {
#             self._col_to_groupby: "first",
#             "proteins": "first",
#             "stripped_peptide": "first",
#             "spectrum_q": "min",
